...
@ComponentScan(basePackages = {"com.ps.tutorial.jpa.dao", "com.ps.tutorial.jpa.services"})
public class DataConfig {
    ...
    @Bean public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        factory.setPackagesToScan("com.ps.tutorial.jpa.model");
    ...
    @Bean public JpaTransactionManager txManager(EntityManagerFactory factory) {
